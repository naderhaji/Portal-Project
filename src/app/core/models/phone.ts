export const phonesNumber = [
  { name: 'Afghanistan', code: 'AF', phone: 93, icon: 'flag:af-4x3' },
  { name: 'Aland Islands', code: 'AX', phone: 358, icon: 'flag:ax-4x3' },
  { name: 'Albania', code: 'AL', phone: 355, icon: 'flag:al-4x3' },
